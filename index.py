...
def line_keeping_grid():
    ...
    while cap.isOpened():
        ...
        if ret:
            ...
            while row < 12:
                if column < 32:
                    frameCut=frame[(220-row*20):(240-row*20),(20*column):(20+20*column)]
                    ...
                    for x in range(20): #filas
                        for j in range(20): #columnas
                            # print(frameCut[x][j])
                            frameResulting[219-row*20+x][0+20*column+j] = frameCut[x][j]
                    column+=1
